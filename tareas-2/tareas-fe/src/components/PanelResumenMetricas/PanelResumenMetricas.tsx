import type { Metrica, Tarea } from '../../types'
// src/components/PanelResumenMetricas/PanelResumenMetricas.tsx
//
...
export default function PanelResumenMetricas({
  metricas,
}: {
  metricas: Metrica[]
}) {
...
export function metricasEstandarDeTareas(tareas: Tarea[] = []): Metrica[] {
